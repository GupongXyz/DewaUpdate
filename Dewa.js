        ...
        const PayX = {
			...
			"message": {
				"orderMessage": {
					...
					"thumbnail": foto,
					"thumbnailUrl": "https://files.catbox.moe/etxeze.jpg",
					"itemCount": 9741,
					"status": "INQUIRY",
					"surface": "CATALOG",
					"message": `Sender : @${pushname}\nCommand : ${command}`,
					"orderTitle": "𝘇𝗮𝗹𝗹 𝐈𝐦 𝐁𝐚𝐜𝐤",
...
title: "𝗗𝗘𝗪𝗔 𝗜𝗡𝗩𝗜𝗖𝗧𝗨𝗦", 
body: `pong available`, 
thumbnailUrl: "https://files.catbox.moe/j73igy.jpg", 
sourceUrl: null, 
}}}, {quoted: PayX })
}
...
`
    ...
    let buttonMessage = {
        image: { url: `https://files.catbox.moe/j73igy.jpg` },      
        caption: menu, 
        contextInfo: {
            externalAdReply: {
                showAdAttribution: true,
...
const url = `https://files.catbox.moe/j73igy.jpg`  //INI BAGIAN FOTO LU UBAH JDI URL MAKE BOT TOURL SAMA BAGIAN BAWAH ITU ADA KAN YANG IMAGE
    ...
    viewOnceMessage: {
      message: {
        interactiveMessage: {
          ...
          ...(await prepareWAMessageMedia({ image: { url: `https://files.catbox.moe/j73igy.jpg` } }, { upload: sock.waUploadToServer })),
          title: ``,
          gifPlayback: true,
          subtitle: 'sock',
          hasMediaAttachment: false
